...
;***********************************************************
;*
;*  Jason_Chen_Lab8_Tx_sourcecode.asm
;*
...
;*  move forward, reverse, turn right, turn left, halt, and
;*  freeze. These actions are mapped to the push buttons PD0,
;*  PD1, PD4, PD5, PD6, and PD7, respectively. Pushing a
...
.equ  Freeze =  0b11111000 ; Action code for freeze command
...
; Func: HandlePD6
; Desc: Called when the PD0 button is pushed; sends the
;   halt command to the robot.
;-----------------------------------------------------------
HandlePD6:
    ldi action, Halt      ; Load halt command to action register
    rcall TransmitAction  ; Call TransmitAction to send the action
    ret                   ; Return from function
...
;   freeze command to the robot.
;-----------------------------------------------------------
HandlePD7:
    ldi action, Freeze    ; Load freeze command to action register
    rcall TransmitAction  ; Call TransmitAction to send the action
    ret                   ; Return from function
